 ...
 */
public class NewMediaPlayerAdapter extends PlayerAdapter {
    ...
    final Runnable mRunnable = new Runnable() {
        @Override
        public void run() {
            getCallback().onCurrentPositionChanged(NewMediaPlayerAdapter.this);
    ...
    MediaPlayer.OnPreparedListener mOnPreparedListener = new MediaPlayer.OnPreparedListener() {
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            if (mSurfaceHolderGlueHost == null || mHasDisplay) {
                getCallback().onPreparedStateChanged(NewMediaPlayerAdapter.this);
            }
        }
    };
    ...
    final MediaPlayer.OnCompletionListener mOnCompletionListener =
            new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mediaPlayer) {
                    getCallback().onPlayStateChanged(NewMediaPlayerAdapter.this);
                    getCallback().onPlayCompleted(NewMediaPlayerAdapter.this);
                }
            };
    ...
    final MediaPlayer.OnBufferingUpdateListener mOnBufferingUpdateListener =
            new MediaPlayer.OnBufferingUpdateListener() {
                ...
                public void onBufferingUpdate(MediaPlayer mp, int percent) {
                    ...
                    getCallback().onBufferedPositionChanged(NewMediaPlayerAdapter.this);
                }
            };
    ...
    final MediaPlayer.OnVideoSizeChangedListener mOnVideoSizeChangedListener =
            new MediaPlayer.OnVideoSizeChangedListener() {
                ...
                public void onVideoSizeChanged(MediaPlayer mediaPlayer, int width, int height) {
                    getCallback().onVideoSizeChanged(NewMediaPlayerAdapter.this, width, height);
                }
            };
    ...
    final MediaPlayer.OnErrorListener mOnErrorListener =
            new MediaPlayer.OnErrorListener() {
                ...
                public boolean onError(MediaPlayer mp, int what, int extra) {
                    getCallback().onError(NewMediaPlayerAdapter.this, what,
                            mContext.getString(R.string.lb_media_player_error, what, extra));
                    return NewMediaPlayerAdapter.this.onError(what, extra);
                }
            };
    ...
    final MediaPlayer.OnSeekCompleteListener mOnSeekCompleteListener =
            new MediaPlayer.OnSeekCompleteListener() {
                ...
                public void onSeekComplete(MediaPlayer mp) {
                    NewMediaPlayerAdapter.this.onSeekComplete();
                }
            };
    ...
    final MediaPlayer.OnInfoListener mOnInfoListener = new MediaPlayer.OnInfoListener() {
        ...
        public boolean onInfo(MediaPlayer mp, int what, int extra) {
            ...
            boolean thisHandled = NewMediaPlayerAdapter.this.onInfo(what, extra);
    ...
    void notifyBufferingStartEnd() {
        getCallback().onBufferingStateChanged(NewMediaPlayerAdapter.this,
     ...
     * Constructor.
     */
    public NewMediaPlayerAdapter(Context context) {
        mContext = context;
    }
    ...
    public void onAttachedToHost(PlaybackGlueHost host) {
        if (host instanceof SurfaceHolderGlueHost) {
            ...
            mSurfaceHolderGlueHost.setSurfaceHolderCallback(new NewMediaPlayerAdapter.VideoPlayerSurfaceHolderCallback());
        }
    }
     ...
     * otherwise.
     */
    public boolean setDataSource(Uri uri, Map<String, String> headers) {
        if (uri == null) {
            return false;
        }
        mMediaSourceUri = uri;
        prepareMediaForPlaying(headers);
        return true;
    }

    private void prepareMediaForPlaying(Map<String, String> headers) {
        reset();
        try {
            if (mMediaSourceUri != null) {
                mPlayer.setDataSource(mContext, mMediaSourceUri, headers);
            } else {
                return;
            }
        } catch (IOException e) {
